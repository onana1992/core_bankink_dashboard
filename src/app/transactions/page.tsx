			...
			<div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
				...
				<div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
					...
					<Link href="/transactions/withdrawal" className="group">
						<div className="p-4 bg-gradient-to-br from-red-50 to-rose-50 border border-red-200 rounded-lg hover:shadow-md transition-all cursor-pointer">
					...
					<Link href="/transactions/transfer" className="group">
						<div className="p-4 bg-gradient-to-br from-blue-50 to-cyan-50 border border-blue-200 rounded-lg hover:shadow-md transition-all cursor-pointer">
					...
					<Link href="/transactions/fee" className="group">
						<div className="p-4 bg-gradient-to-br from-orange-50 to-amber-50 border border-orange-200 rounded-lg hover:shadow-md transition-all cursor-pointer">
					...
					<Link href="/transactions/interest" className="group">
						<div className="p-4 bg-gradient-to-br from-purple-50 to-pink-50 border border-purple-200 rounded-lg hover:shadow-md transition-all cursor-pointer">
					...
					<Link href="/transactions/adjustment" className="group">
						<div className="p-4 bg-gradient-to-br from-indigo-50 to-violet-50 border border-indigo-200 rounded-lg hover:shadow-md transition-all cursor-pointer">
					...
					<Link href="/transactions/reversal" className="group">
						<div className="p-4 bg-gradient-to-br from-gray-50 to-slate-50 border border-gray-200 rounded-lg hover:shadow-md transition-all cursor-pointer">
						...
						<table className="min-w-full divide-y divide-gray-200">
							<thead className="bg-gray-50">
								<tr>
									...
									<th className="px-6 py-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">{t("transaction.list.table.type")}</th>
									<th className="px-6 py-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">{t("transaction.list.table.account")}</th>
									<th 
									...
									<th className="px-6 py-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">{t("transaction.list.table.status")}</th>
									<th 
										className="px-6 py-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider cursor-pointer hover:bg-gray-100 transition-colors"
										onClick={() => {
											if (sortBy === "transactionDate") {
									...
									<th className="px-6 py-4 text-right text-xs font-bold text-gray-700 uppercase tracking-wider">{t("transaction.list.table.actions")}</th>
								</tr>
							</thead>
